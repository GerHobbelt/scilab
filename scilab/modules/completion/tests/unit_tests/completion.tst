...
r = completion("ho");
assert_checkequal(r, ["home"; "horizontalalignment"; "horner"; "host"; "hot"; "hours"; "householder"]);
...
assert_checkequal(r, ["horner"; "hot"; "hours"; "householder"]);
...
assert_checkequal(macros, ["horner"; "hot"; "hours"; "householder"]);
